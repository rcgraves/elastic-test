...
docker pull $DOCKERHUB/so-freqserver
docker pull $DOCKERHUB/so-domainstats
...
cp -av $REPO/configfiles-setup_required/8*_postprocess_dns_*_tagging.conf /etc/logstash/optional/
